...
export const CATEGORIES: Category[] = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        accent: 'var(--sky-600)', accentBg: 'var(--sky-100)', tiers: [0, 0, 1, 1],
  ...
  },
  {
    ...
    secondary: { label: 'See what you’d keep', to: '#calculator' },
    seo: 'Branded giving, fundraising campaigns, a donor and member CRM, QuickBooks-synced receipts and a lifetime affiliate program — with up to 100% donation retention.',
    features: [
      {
        ...
        oneliner: 'Give in three taps. Every dollar lands in your church\'s own Stripe account — Harvest takes 5% on Individual and Small Team, 2.5% on Community, 0% on Ministry, and never holds your money.',
        moment: 'Most platforms take 2–5% of every gift, forever, with no way down. Harvest’s fee falls as you grow — 5%, then 2.5% on Community, then zero on Ministry, where a church doing $200k a year online keeps the $10,000 that used to just disappear.',
      ...
      {
        id: 'affiliate', name: 'Lifetime Affiliate', n: '5',
        accent: 'var(--gold-600)', accentBg: 'var(--gold-100)', tiers: [1, 1, 1, 1],
        eyebrow: '15% for as long as they stay',
        title: 'Refer a ministry. Earn 15%, every month.',
        oneliner: 'A flat 15% of what every church you refer pays — recurring on every invoice, for as long as they stay, paid out automatically through Stripe.',
        moment: 'Most SaaS affiliate programs pay once. Harvest pays 15% on every renewal, indefinitely — refer five churches on the $299 plan and that’s about $224 a month, for as long as they stay.',
        admin: ['Flat 15% — every plan, no tiers, no ladder', 'Recurring on every invoice, paid via Stripe transfers', 'Trial starts don\'t count — only converted customers', 'Paid to the Stripe account you already use'],
        member: ['A referral link, generated automatically', 'This-month pending & lifetime earnings at a glance', 'Get paid even if you finish payout setup later'],
    ...
    features: [
      {
        ...
        admin: ['Your own subdomain, or your domain on Ministry', 'Tabs appear only when there’s something behind them', 'A real desktop layout, not a stretched phone view', 'Every request scoped to your tenant, in security rules'],
      ...
      },
      {
        ...
        member: ['Installs like any app — no store, no account', 'Everyone gets your-church.theharvest.app; Ministry adds a custom domain', 'Your branding on Community & Ministry; Harvest’s on lower plans', 'Launches standalone; cached content reads on a weak signal'],
      ...
      },
      {
        ...
        oneliner: 'Set your ministry name, logo, square icon and brand colour once, and on Ministry point your own domain at it. The platform goes invisible.',
        ...
        member: ['An app that looks like yours, not ours', 'Your domain in the address bar', 'Receipts & certificates on your letterhead', 'Branding starts on Community; domain on Ministry'],
      ...
      },
      {
        ...
        moment: 'A planting network with 12 campuses knows their bill is $479 + $110 before they talk to anyone. No sales call, no custom quote — every competitor hides multi-site pricing behind a form.',
      ...
      },
      {
        ...
        moment: '“Which country is the harvest in this month?” Countries represented, drillable, with the faith question attached — on the $59 plan. It’s the kind of number a pastor screenshots for a board meeting.',
        ...
        member: ['A required, editable faith question at onboarding', 'Their location powers the missions view', 'Pairs with geo-targeted posting to reach a city', 'On every plan, including $59'],
