    ...
    features: [
      {
        ...
        moment: 'Most platforms take 2–5% of every gift, forever, with no way down. Harvest takes zero — on the $39 plan and every plan above it. On a church doing $200k a year online, a 5% platform quietly takes $10,000. Harvest takes none of it; you pay us a flat subscription and nothing else.',
         ...
         un-hide the entry, until that migration ships. */
      {
        ...
        moment: 'Most SaaS affiliate programs pay once, on the first payment. Harvest pays for a full year — refer five churches on the $159 plan and that’s about $119 a month for twelve months, roughly $1,431 in total.',
  ...
  },
  {
    ...
    features: [
         ...
         quietly relabel it as a Ministry feature. */
      {
        ...
        moment: 'A planting network with 12 campuses knows their bill is $159 + $220 before they talk to anyone: one campus is in the plan, the other eleven are $20 each. No sales call, no custom quote — every competitor hides multi-site pricing behind a form.',
      ...
      },
      {
        ...
        moment: '“Which country is the harvest in this month?” Countries represented, drillable, with the faith question attached — on the $39 plan. It’s the kind of number a pastor screenshots for a board meeting.',
        ...
        member: ['A required, editable faith question at onboarding', 'Their location powers the missions view', 'Pairs with geo-targeted posting to reach a city', 'On every plan, including $39'],
