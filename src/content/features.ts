    ...
    features: [
      {
        ...
        oneliner: 'Give in three taps. Every dollar lands in your church\'s own Stripe account — Harvest takes 0% on Ministry, 2.5% on Community, and never holds your money.',
        moment: 'Most platforms take 2–5% of every gift, forever, on every plan. Harvest’s fee falls to zero on Ministry — a church doing $200k a year online keeps up to $10,000 that used to just disappear.',
