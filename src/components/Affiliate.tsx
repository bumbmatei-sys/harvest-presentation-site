...
const steps = [
  ...
  { icon: 'trending-up', title: 'You earn monthly', desc: 'Earn 30% recurring commission on every invoice for their first 12 months.' },
];
      ...
      <div style={container}>
        ...
        <Reveal delay={120} style={{ maxWidth: 460, margin: '32px auto 0' }}>
          <div style={{ ...softCard, padding: '24px', textAlign: 'center' }}>
            ...
            <div style={{ fontFamily: 'var(--font-serif)', fontSize: 17, fontWeight: 600, color: 'var(--brand)' }}>30% / month, for 12 months</div>
          </div>
